...
export function useEngine() {
    ...
    useEffect(() => {
        ...
        const { canvas, gl, initShaders } = nonengine;

        const shaderProgram = initShaders(vertexShaderCode, fragmentShaderCode);
        ...
        // 看似一样，实则需要上面两行代码执行后
        // 按理说也是自己定义的，不知道为什么非得放到后面，看来都得放到后面
