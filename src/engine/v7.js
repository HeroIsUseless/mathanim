...
export function useEngine() {
    ...
    useEffect(() => {
        ...
        image.onload = function(e) {
            ...
            document.getElementById('test-img').appendChild(image);

            const program = initShaders(vertexShaderCode, fragmentShaderCode);
            ...
            // 绘制图形
            // 这个是怎么绘制的，绘制几次？
            // 顶点着色器每运行三次WebGL将会根据三个gl_Position值绘制一个三角形
            // 另外每多出一个点，多一个三角形，目前是有4个顶点，颜色也有4个
            ...
            // gl.TRIANGLES 表示绘制一系列单独的三角形，三角形的三个点分别是(v0,v1,v2),(v3,v4,v5)...如果顶点不足则不绘制
            ...
            // 目前是左下，左上，右上，右下，因此用TRIANGLE_FAN，而颜色在顶点上，线上的颜色只与两点的颜色有关
            gl.drawArrays(
